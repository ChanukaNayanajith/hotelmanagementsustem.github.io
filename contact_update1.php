...
<html>
<head>
	<title>KINGS HOTEL | Contact Us</title>
...
<br><br><br>
<div class="container">
	<form action="contact_update.php" method="POST" name="contact us">
		<p>CONTACT US</p>
			
			<div class="login">
				<label>First Name</label>
					<input type ="text" name="fname" placeholder="Your Full Name" class="input">
				<label>Email</label>
