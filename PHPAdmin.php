...
<head>
    ...
    <script src="js/WedAdmin.js"></script>
...
<body>
    ...
    <button class="phpbutton" id="register" onclick="loadpage('register')">Registration Page Details</button>
    <button class="phpbutton" id="contact" onclick="loadpage('contact')">Contact Us Page Details</button>
    <button class="phpbutton" id="packages" onclick="loadpage('packages')">user chosed package details</button>
    <button class="phpbutton" id="about" onclick="loadpage('about')">About Us Page Details</button>
    <button class="phpbutton" id="Details" onclick="loadpage('Details')">Registration Page Details</button>
    <button class="phpbutton" id="login" onclick="loadpage('login')">Login Page Details</button>
    <button class="phpbutton" id="customerlog" onclick="loadpage('customerlog')">customer login details</button>
    <button class="phpbutton" id="cdetails" onclick="loadpage('cdetails')">customer details</button>
